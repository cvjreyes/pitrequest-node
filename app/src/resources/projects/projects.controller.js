...
const getProjectsByUser = async (req, res) => {
  ...
  sql.query(
    "SELECT projects.id, projects.code FROM model_has_projects JOIN projects ON model_has_projects.project_id = projects.id WHERE user_id = ?",
    [userid],
    (err, results) => {
      if (err) {
        console.log(err);
...
const getProjectsByEmail = async (req, res) => {
  ...
  sql.query(
    "SELECT projects.* FROM model_has_projects JOIN projects ON model_has_projects.project_id = projects.id JOIN users ON model_has_projects.user_id = users.id WHERE users.email = ? AND active = 1 ORDER BY projects.name ASC",
    [email],
    (err, results) => {
      if (err) {
        console.log(err);
...
const updateProjects = async (req, res) => {
  ...
  sql.query(
    "DELETE FROM model_has_projects WHERE user_id = ?",
    [userid],
    (err, results) => {
      if (err) {
        console.log(err);
        ...
        for (let i = 0; i < projects.length; i++) {
          sql.query(
            "INSERT INTO model_has_projects(user_id, project_id) VALUES(?,?)",
            [userid, projects[i]],
            (err, results) => {
              if (err) {
                console.log(err);
...
const getAdmins = async (req, res) => {
  sql.query(
    "SELECT users.name FROM users LEFT JOIN model_has_roles ON users.id = model_has_roles.model_id WHERE role_id = 14",
    (err, results) => {
      if (!results[0]) {
...
const changeAdmin = async (req, res) => {
  ...
  sql.query(
    "SELECT users.id, users.email FROM users WHERE name = ?",
    [admin],
    (err, results) => {
      //Cogemos el usurio admin nuevo
      if (!results[0]) {
        ...
        sql.query(
          ...
          [current_admin_mail],
          (err, results) => {
            //Cogemos el nombre del admin actual
            if (!results[0]) {
              ...
              if (type == "NWC") {
                ...
                sql.query(
                  "UPDATE qtracker_not_working_component SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      res.status(401);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        ...
                        sql.query(
                          "SELECT qtracker_not_working_component.*, projects.name as project, users.name as user, users.email FROM qtracker_not_working_component JOIN projects ON qtracker_not_working_component.project_id = projects.id JOIN users ON qtracker_not_working_component.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                ...
                sql.query(
                  "UPDATE qtracker_not_view_in_navis SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_not_view_in_navis.*, projects.name as project, users.name as user, users.email FROM qtracker_not_view_in_navis JOIN projects ON qtracker_not_view_in_navis.project_id = projects.id JOIN users ON qtracker_not_view_in_navis.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                ...
                sql.query(
                  "UPDATE qtracker_general SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_general.*, projects.name as project, users.name as user, users.email FROM qtracker_general JOIN projects ON qtracker_general.project_id = projects.id JOIN users ON qtracker_general.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                        ...
                        sql.query(
                          ...
                          (err, results) => {
                            if (!results[0]) {
                              ...
                              const html_message =
                                "<p><b>INCIDENCE</b> NOT VIEW IN ORTOGRAPHIC DRAWING</p> <p><b>REFERENCE</b> " +
                                incidence_number +
                                " </p> <p><b>PROJECT</b> " +
                                incidence.project +
                                " </p> <p><b>USER</b> " +
                        ...
                        sql.query(
                          ...
                          (err, results) => {
                            if (!results[0]) {
                              ...
                              const html_message =
                                "<p><b>INCIDENCE</b> NOT VIEW IN CITRIX</p> <p><b>REFERENCE</b> " +
                                incidence_number +
                                " </p> <p><b>PROJECT</b> " +
                                incidence.project +
                                " </p> <p><b>USER</b> " +
                        ...
                        sql.query(
                          ...
                          (err, results) => {
                            if (!results[0]) {
                              ...
                              const html_message =
                                "<p><b>INCIDENCE</b> NOT VIEW IN ACCESS ISSUE</p> <p><b>REFERENCE</b> " +
                                incidence_number +
                                " </p> <p><b>PROJECT</b> " +
                                incidence.project +
                                " </p> <p><b>USER</b> " +
                        ...
                        sql.query(
                          ...
                          (err, results) => {
                            if (!results[0]) {
                              ...
                              const html_message =
                                "<p><b>INCIDENCE</b> NOT VIEW IN CHANGE APPLICATION</p> <p><b>REFERENCE</b> " +
                                incidence_number +
                                " </p> <p><b>PROJECT</b> " +
                                incidence.project +
                                " </p> <p><b>USER</b> " +
                        ...
                        sql.query(
                          ...
                          (err, results) => {
                            if (!results[0]) {
                              ...
                              const html_message =
                                "<p><b>INCIDENCE</b> NOT VIEW IN OTHERS</p> <p><b>REFERENCE</b> " +
                                incidence_number +
                                " </p> <p><b>PROJECT</b> " +
                                incidence.project +
                                " </p> <p><b>USER</b> " +
                ...
                sql.query(
                  "UPDATE qtracker_not_reporting_isometric SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_not_reporting_isometric.*, projects.name as project, users.name as user, users.email FROM qtracker_not_reporting_isometric JOIN projects ON qtracker_not_reporting_isometric.project_id = projects.id JOIN users ON qtracker_not_reporting_isometric.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                ...
                sql.query(
                  "UPDATE qtracker_not_reporting_bfile SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_not_reporting_bfile.*, projects.name as project, users.name as user, users.email FROM qtracker_not_reporting_bfile JOIN projects ON qtracker_not_reporting_bfile.project_id = projects.id JOIN users ON qtracker_not_reporting_bfile.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                ...
                sql.query(
                  "UPDATE qtracker_not_reporting_ifc_dgn_step SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_not_reporting_ifc_dgn_step.*, projects.name as project, users.name as user, users.email FROM qtracker_not_reporting_ifc_dgn_step JOIN projects ON qtracker_not_reporting_ifc_dgn_step.project_id = projects.id JOIN users ON qtracker_not_reporting_ifc_dgn_step.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                ...
                sql.query(
                  "UPDATE qtracker_request_report SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_request_report.*, projects.name as project, users.name as user, users.email FROM qtracker_request_report JOIN projects ON qtracker_request_report.project_id = projects.id JOIN users ON qtracker_request_report.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
                ...
                sql.query(
                  "UPDATE qtracker_isometric_sending SET admin_id = ? WHERE incidence_number = ?",
                  [admin_id, incidence_number],
                  (err, results) => {
                    if (err) {
                      console.log(err);
                      ...
                      if (process.env.NODE_MAILING == "1") {
                        sql.query(
                          "SELECT qtracker_isometric_sending.*, projects.name as project, users.name as user, users.email FROM qtracker_isometric_sending JOIN projects ON qtracker_isometric_sending.project_id = projects.id JOIN users ON qtracker_isometric_sending.user_id = users.id WHERE incidence_number = ?",
                          [incidence_number],
                          (err, results) => {
                            if (!results[0]) {
                              console.log("No admin mail");
...
const getTasks = async (req, res) => {
  sql.query(
    "SELECT softwares.id as software_id, softwares.name as software, tasks.id as task_id, tasks.name as task, subtasks1.id as subtask_id, subtasks1.name as subtask FROM softwares LEFT JOIN tasks ON softwares.id = tasks.software_id LEFT JOIN subtasks1 ON tasks.id = subtasks1.task_id ORDER BY tasks.name ASC",
    (err, results) => {
      if (!results[0]) {
...
const getTasksPopUp = async (req, res) => {
  //Cogemos todos los softwares con sus tareas y subtareas
  sql.query(
    "SELECT softwares.id as software_id, softwares.name as software, tasks.id as task_id, tasks.name as task, subtasks1.id as subtask_id, subtasks1.name as subtask FROM softwares LEFT JOIN tasks ON softwares.id = tasks.software_id LEFT JOIN subtasks1 ON tasks.id = subtasks1.task_id ORDER BY software ASC",
    (err, results) => {
      if (!results[0]) {
        console.log("No tasks created");
        res.json({ tasks: null }).status(401);
...
const createProject = async (req, res) => {
  ...
  sql.query("SELECT id FROM users WHERE name = ?", [admin], (err, results) => {
    //Cogemos el usuario que ha creado el usuario
    if (!results[0]) {
      res.status(401);
    } else {
      const admin_id = results[0].id;
      ...
      sql.query(
        "INSERT INTO projects(name, code, default_admin_id, sup_estihrs) VALUES(?,?,?,?)",
        [name, code, admin_id, hours],
        (err, results) => {
          if (err) {
            console.log(err);
            res.status(401);
                ...
                if (!results[0]) {
                  ...
                  if (tasks) {
                    for (let i = 0; i < tasks.length; i++) {
                      //Le asignamos al proyecto cada subtarea
                      sql.query(
                        "INSERT INTO project_has_tasks(project_id, subtask1_id, admin_id) VALUES(?,?,?)",
                        [project_id, parseInt(tasks[i], 10), admin_id],
                        (err, results) => {
                          if (err) {
                            console.log(err);
                          }
...
const updateStatus = async (req, res) => {
  ...
  sql.query(
    "UPDATE project_has_tasks SET status = ? WHERE id = ?",
    [status_id, task_id],
    (err, results) => {
      if (err) {
        console.log(err);
        ...
        sql.query(
          "UPDATE project_has_tasks SET accept_reject_date = ? WHERE ID = ?",
          [currentDate, task_id],
          (err, results) => {
            if (err) {
              console.log(err);
...
const updateObservations = async (req, res) => {
  ...
  sql.query(
    "UPDATE project_has_tasks SET observations = ? WHERE id = ?",
    [observation, task_id],
    (err, results) => {
      if (err) {
        console.log(err);
...
const updateHours = async (req, res) => {
  ...
  sql.query(
    "UPDATE project_has_tasks SET realhrs = ? WHERE id = ?",
    [hours, task_id],
    (err, results) => {
      if (err) {
        console.log(err);
...
const changeAdminProjectTask = async (req, res) => {
  //Cambiar el admin asignado a una tarea funciona igual que cambiar el admin asignado a una incidencia
  const current_admin_mail = req.body.currentAdmin;
  const admin = req.body.admin;
  const task_id = req.body.task_id;
  sql.query(
        ...
        sql.query(
          ...
          (err, results) => {
            if (!results[0]) {
              ...
              const current_admin = results[0].name;
              sql.query(
                "UPDATE project_has_tasks SET admin_id = ? WHERE id = ?",
                [admin_id, task_id],
                (err, results) => {
                  if (err) {
                    console.log(err);
...
const getAllPTS = async (req, res) => {
  sql.query("SELECT name, sup_estihrs FROM projects", (err, results) => {
    ...
    sql.query(
      "SELECT tasks.name as task, softwares.name as software, subtasks1.name as subtask, subtasks1.estihrs as hours FROM tasks LEFT JOIN subtasks1 ON tasks.id = subtasks1.task_id LEFT JOIN softwares ON software_id = softwares.id",
      (err, results) => {
        if (!results[0]) {
...
const submitProjectsChanges = async (req, res) => {
  ...
  for (let i = 0; i < new_nodes.length; i++) {
    //Por cada nuevo nodo
    sql.query(
      "SELECT id, default_admin_id FROM projects WHERE projects.name = ?",
      [new_nodes[i].project],
      (err, results) => {
        //Cogemos el id y admin del proyecto
        if (results[0]) {
          let project_id = results[0].id;
          let admin_id = results[0].default_admin_id;
          sql.query(
            "SELECT id from subtasks1 WHERE name = ?",
            [new_nodes[i].subtask],
            (err, results) => {
              //Cogemos el id de la subtarea
              if (results[0]) {
                let subtask_id = results[0].id;
                //Se lo asignamos al proyecto
                sql.query(
                  "INSERT INTO project_has_tasks(project_id, subtask1_id, admin_id) VALUES(?,?,?)",
                  [project_id, subtask_id, admin_id],
                  (err, results) => {
                    if (err) {
                      res.send({ success: false }).status(401);
                    }
  ...
  for (let i = 0; i < removed_nodes.length; i++) {
    //Lo mismo pero eliminando en vez de creando
    sql.query(
      "SELECT id, default_admin_id FROM projects WHERE projects.name = ?",
      [removed_nodes[i].project],
      (err, results) => {
        if (results[0]) {
          let project_id = results[0].id;
          let admin_id = results[0].default_admin_id;
          sql.query(
            "SELECT id from subtasks1 WHERE name = ?",
            [removed_nodes[i].subtask],
            (err, results) => {
              if (results[0]) {
                let subtask_id = results[0].id;
                sql.query(
                  "DELETE FROM project_has_tasks WHERE project_id = ? AND subtask1_id = ? AND admin_id = ?",
                  [project_id, subtask_id, admin_id],
                  (err, results) => {
                    if (err) {
                      res.send({ success: false }).status(401);
...
const getSubtaskHours = async (req, res) => {
  ...
  sql.query(
    "SELECT estihrs FROM subtasks1 WHERE id = ?",
    [subtask],
    (err, results) => {
      if (!results[0]) {
...
const submitTasks = async (req, res) => {
  ...
  for (let i = 0; i < tasks.length; i++) {
    ...
    if (
      ...
      sql.query(
        "SELECT id FROM softwares WHERE name = ?",
        [tasks[i]["Software"]],
        (err, results) => {
          //Cogemos el id del software
          if (!results[0]) {
            console.log(err);
            res.send({ success: false }).status(401);
          } else {
            ...
            sql.query(
              ...
              (err, results) => {
                //Cogemos la tarea
                if (!results[0]) {
                  //Si no tiene id es que es nueva
                  sql.query(
                    "INSERT INTO tasks(name, software_id) VALUES(?,?)",
                    [tasks[i]["Task"], software_id],
                    (err, results) => {
                      //Agregamos la tarea
                      if (err) {
                        console.log(err);
                  ...
                  //Si tiene la actualizamos
                  sql.query(
                    "UPDATE tasks SET name = ?, software_id = ? WHERE id = ?",
                    [tasks[i]["Task"], software_id, tasks[i]["id"]],
                    (err, results) => {
                      if (err) {
                        console.log(err);
                        res.send({ success: false }).status(401);
...
const submitSubtasks = async (req, res) => {
  ...
  for (let i = 0; i < subtasks.length; i++) {
    if (
      ...
      sql.query(
        "DELETE FROM subtasks1 WHERE id = ?",
        [subtasks[i]["id"]],
        (err, results) => {
          if (err) {
            console.log(err);
      ...
      sql.query(
        ...
        (err, results) => {
          if (!results[0]) {
            ...
            sql.query(
              "SELECT * FROM subtasks1 WHERE id = ?",
              [subtasks[i]["id"]],
              (err, results) => {
                if (!results[0]) {
                  sql.query(
                    "INSERT INTO subtasks1(name, task_id, estihrs) VALUES(?,?,?)",
                    [subtasks[i]["Subtask"], task_id, subtasks[i]["Hours"]],
                    (err, results) => {
                      if (err) {
                        console.log(err);
                        res.send({ success: false }).status(401);
                  ...
                  sql.query(
                    "UPDATE subtasks1 SET name = ?, task_id = ?, estihrs = ? WHERE id = ?",
                    [
                      subtasks[i]["Subtask"],
                      task_id,
                      subtasks[i]["Hours"],
...
const isAdmin = async (req, res) => {
  sql.query(
    "SELECT * FROM model_has_roles JOIN users ON model_has_roles.model_id = users.id WHERE model_has_roles.role_id = 14 AND users.email = ?",
    [req.params.email],
    (err, results) => {
      if (!results[0]) {
...
const getProjectsWithHours = async (req, res) => {
  sql.query(
    "SELECT projects.*, users.name as admin FROM projects LEFT JOIN users ON projects.default_admin_id = users.id",
    (err, results) => {
      if (!results[0]) {
        res.send({ success: false }).status(401);
      } else {
          ...
          if (!results[0]) {
            ...
            sql.query(
              ...
              (err, results) => {
                if (results[0]) {
                  sql.query(
                    "UPDATE projects SET name = ?, sup_estihrs = ?, default_admin_id = ?, active = ? WHERE id = ?",
                    [
                      projects[i]["Project"],
                      projects[i]["Hours"],
                      admin_id,
                      Number(projects[i]["Active"]),
                      projects[i]["id"],
                    ],
                    (err, results) => {
                      if (err) {
...
const submitOffersChanges = async (req, res) => {
  ...
  for (let i = 0; i < new_nodes.length; i++) {
    sql.query(
      "SELECT id FROM offers WHERE offers.name = ?",
      [new_nodes[i].offer],
      (err, results) => {
        if (results[0]) {
          ...
          sql.query(
            ...
            (err, results) => {
              if (results[0]) {
                let subtask_id = results[0].id;
                sql.query(
                  "INSERT INTO offer_has_tasks(offer_id, subtask1_id) VALUES(?,?)",
                  [offer_id, subtask_id],
                  (err, results) => {
                    if (err) {
                      res.send({ success: false }).status(401);
          ...
          sql.query(
            ...
            (err, results) => {
              if (results[0]) {
                let subtask_id = results[0].id;
                sql.query(
                  "DELETE FROM offer_has_tasks WHERE offer_id = ? AND subtask1_id = ?",
                  [offer_id, subtask_id],
                  (err, results) => {
                    if (err) {
                      res.send({ success: false }).status(401);
    ...
    if (!offers[i]["Offer"] || offers[i]["Offer"] == "") {
      ...
      sql.query(
        ...
        (err, results) => {
          if (results[0]) {
            sql.query(
              "UPDATE offers SET name = ?, sup_estihrs = ? WHERE id = ?",
              [offers[i]["Offer"], offers[i]["Hours"], offers[i]["id"]],
              (err, results) => {
                if (err) {
                  console.log(err);
                  res.send({ success: false }).status(401);
...
const createOffer = async (req, res) => {
  ...
  sql.query(
    "INSERT INTO offers(name, code, sup_estihrs) VALUES(?,?,?)",
    [name, code, hours],
    (err, results) => {
      //Creamos la oferta
      if (err) {
        ...
        sql.query(
          "SELECT id FROM offers WHERE name = ?",
          [name],
          (err, results) => {
            //Cogemos el id de la oferta
            if (!results[0]) {
              res.status(401);
            } else {
...
const getUsersByProject = async (req, res) => {
  sql.query(
    "SELECT email FROM users JOIN model_has_projects ON users.id = model_has_projects.user_id JOIN projects ON model_has_projects.project_id = projects.id WHERE projects.id = ? AND users.id != 1",
