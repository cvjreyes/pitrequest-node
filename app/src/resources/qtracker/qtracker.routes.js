module.exports = app => {
  ...
  app.post("/qtracker/requestINMI", qtracker.requestINMI)
  ...
  app.get("/qtracker/getINMI", qtracker.getINMI)
  ...
  app.get("/qtracker/getINMIByProjects/:email", qtracker.getINMIByProjects)
